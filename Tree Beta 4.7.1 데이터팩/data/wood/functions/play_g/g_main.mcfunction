...
execute as @a[scores={GTree2=1}] run tellraw @s [{"text":"나무의 원목갯수 만큼 금조각이 지급됩니다!","color":"#abffab","bold":true}]
execute as @a[scores={GTree2=1}] run tellraw @s [{"text":"(원목 1개 = 금조각 1개)\n","color":"gray","bold":true}]
...
execute as @a[scores={Gticket=2..}] if score @s playGTree matches 1 if score @s playG matches 1 run scoreboard players set @s GTree 3
execute as @a[scores={Gticket=0..1}] if score @s playGTree matches 1 if score @s playG matches 1 run tellraw @s {"text":"도박티켓 부족!","color":"red"}
execute as @a[scores={Gticket=0..1}] if score @s playGTree matches 1 if score @s playG matches 1 at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 1 1
execute as @a[scores={Gticket=0..1}] if score @s playGTree matches 1 if score @s playG matches 1 at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 1 1
execute as @a[scores={Gticket=0..1}] if score @s playGTree matches 1 if score @s playG matches 1 run scoreboard players set @s playG 0
execute as @a[scores={Gticket=0..1}] if score @s playGTree matches 1 run scoreboard players set @s playGTree 0
execute as @a[scores={Gticket=0..}] if score @s playGTree matches 1 run scoreboard players set @s Gticket -1
execute as @a[scores={GTree=3}] run clear @s name_tag{display:{Name:'[{"text":"도박티켓","color":"dark_green","italic":false,"bold":true}]'}} 2
...
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"나무 : ","color":"#685437","bold":true},{"text":"금괴 32개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"금 : ","color":"gold","bold":true},{"text":"금괴 20개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"다이아몬드 : ","color":"aqua","bold":true},{"text":"금괴 16개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"에메랄드 : ","color":"green","bold":true},{"text":"금괴 8개","color":"#66dd66","bold":true}]
...
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"청금석 1개 : ","color":"blue","bold":true},{"text":"금조각 15개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"청금석 2개 : ","color":"blue","bold":true},{"text":"금조각 32개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"청금석 3개 : ","color":"blue","bold":true},{"text":"금괴 1개","color":"#66dd66","bold":true}]
execute as @a[scores={GTma=1}] run tellraw @s [{"text":"\n비용 : 도박티켓 5개\n","color":"gold","bold":true}]
...
execute as @a[scores={Gticket=5..}] if score @s playGTma matches 1 if score @s playG matches 3 run scoreboard players set @s GTma2 2
execute as @a[scores={Gticket=0..4}] if score @s playGTma matches 1 if score @s playG matches 3 run tellraw @s {"text":"도박티켓 부족!","color":"red"}
execute as @a[scores={Gticket=0..4}] if score @s playGTma matches 1 if score @s playG matches 3 at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 1 1
execute as @a[scores={Gticket=0..4}] if score @s playGTma matches 1 if score @s playG matches 3 at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 1 1
execute as @a[scores={Gticket=0..4}] if score @s playGTma matches 1 if score @s playG matches 3 run scoreboard players set @s playG 0
execute as @a[scores={Gticket=0..4}] if score @s playGTma matches 1 run scoreboard players set @s playGTma 0
execute as @a[scores={Gticket=0..}] if score @s playGTma matches 1 run scoreboard players set @s Gticket -1
execute as @a[scores={GTma2=2}] run clear @s name_tag{display:{Name:'[{"text":"도박티켓","color":"dark_green","italic":false,"bold":true}]'}} 5
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 1 if score second GTma2 matches 1 if score third GTma2 matches 1 run give @s gold_ingot 32
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 2 if score second GTma2 matches 2 if score third GTma2 matches 2 run give @s gold_ingot 20
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 3 if score second GTma2 matches 3 if score third GTma2 matches 3 run give @s gold_ingot 16
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 4 if score second GTma2 matches 4 if score third GTma2 matches 4 run give @s gold_ingot 8
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 if score second GTma2 matches 6 if score third GTma2 matches 6 run give @s gold_ingot 1
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 unless score second GTma2 matches 6 unless score third GTma2 matches 6 run give @s gold_nugget 15
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 if score second GTma2 matches 6 unless score third GTma2 matches 6 run give @s gold_nugget 15
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 unless score second GTma2 matches 6 if score third GTma2 matches 6 run give @s gold_nugget 15
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 if score second GTma2 matches 6 if score third GTma2 matches 6 run give @s gold_nugget 32
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 unless score second GTma2 matches 6 if score third GTma2 matches 6 run give @s gold_nugget 32
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 if score second GTma2 matches 6 unless score third GTma2 matches 6 run give @s gold_nugget 32
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 if score second GTma2 matches 6 if score third GTma2 matches 6 run scoreboard players set get GTma2 1
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 unless score second GTma2 matches 6 if score third GTma2 matches 6 run scoreboard players set get GTma2 1
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 if score second GTma2 matches 6 unless score third GTma2 matches 6 run scoreboard players set get GTma2 1
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 at @s if score get GTma2 matches -1 run playsound minecraft:block.beacon.deactivate master @s ~ ~ ~ 1 0.9
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 1 if score second GTma2 matches 1 if score third GTma2 matches 1 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"32","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 2 if score second GTma2 matches 2 if score third GTma2 matches 2 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"20","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 3 if score second GTma2 matches 3 if score third GTma2 matches 3 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"16","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 4 if score second GTma2 matches 4 if score third GTma2 matches 4 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"8","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 if score second GTma2 matches 6 if score third GTma2 matches 6 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"1","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
...
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 unless score second GTma2 matches 6 unless score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"15","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 if score second GTma2 matches 6 unless score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"15","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 unless score second GTma2 matches 6 if score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"15","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 unless score first GTma2 matches 6 if score second GTma2 matches 6 if score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"32","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 unless score second GTma2 matches 6 if score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"32","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTma=1}] if score play GTma2 matches 0 if score first GTma2 matches 6 if score second GTma2 matches 6 unless score third GTma2 matches 6 run tellraw @s [{"text":"금조각 ","color":"gold","bold":true},{"text":"32","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
...
execute if score play GTroad2 >= 0 num if score lvl GTroad2 matches 5 as @a[scores={playGTroad=1}] run title @s actionbar [{"text":"성공확률 : ","color":"#0080ff","bold":true},{"text":"50%","color":"#0080ff","bold":false},{"text":" / ","color":"#abffab","bold":false},{"text":"현재보상 : 금조각 32개","color":"aqua","bold":true},{"text":" / ","color":"#abffab","bold":false},{"text":"다음보상 : 금괴 1개","color":"gold","bold":true}]
execute if score play GTroad2 >= 0 num if score lvl GTroad2 matches 6 as @a[scores={playGTroad=1}] run title @s actionbar [{"text":"성공확률 : ","color":"#0080ff","bold":true},{"text":"40%","color":"#0080ff","bold":false},{"text":" / ","color":"#abffab","bold":false},{"text":"현재보상 : 금괴 1개","color":"aqua","bold":true},{"text":" / ","color":"#abffab","bold":false},{"text":"다음보상 : 금괴 4개","color":"gold","bold":true}]
execute if score play GTroad2 >= 0 num if score lvl GTroad2 matches 7 as @a[scores={playGTroad=1}] run title @s actionbar [{"text":"성공확률 : ","color":"#0080ff","bold":true},{"text":"30%","color":"#0080ff","bold":false},{"text":" / ","color":"#abffab","bold":false},{"text":"현재보상 : 금괴 4개","color":"aqua","bold":true},{"text":" / ","color":"#abffab","bold":false},{"text":"다음보상 : 금괴 16개","color":"gold","bold":true}]
...
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 6 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"1","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 7 run tellraw @s [{"text":"금괴 ","color":"gold","bold":true},{"text":"4","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
...
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 10 run tellraw @s [{"text":"금블럭 ","color":"gold","bold":true},{"text":"12","color":"green","bold":false},{"text":"개 획득!","color":"gold","bold":true}]
...
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 6 run give @s minecraft:gold_ingot 1
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 7 run give @s minecraft:gold_ingot 4
...
execute as @a[scores={playGTroad=1}] at @s if score play GTroad2 matches -1 if score get GTroad2 matches 1 if score lvl GTroad2 matches 10 run give @s minecraft:gold_block 12
