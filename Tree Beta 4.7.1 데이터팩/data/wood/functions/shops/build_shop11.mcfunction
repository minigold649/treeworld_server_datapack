...
# [oak_log / 1] <- [polished_deepslate / 1]
# [oak_log / 1] <- [polished_diorite / 1]
# [oak_log / 1] <- [polished_andesite / 1]
# [oak_log / 1] <- [polished_granite / 1]
# [oak_log / 1] <- [deepslate_bricks / 1]
# [oak_log / 1] <- [stone_bricks / 1]
# [oak_log / 1] <- [stone / 1]
# [oak_log / 1] <- [bricks / 1]
# [oak_log / 1] <- [deepslate_tiles / 1]

# [oak_log / 1] <- [polished_deepslate_stairs / 1]
# [oak_log / 1] <- [polished_diorite_stairs / 1]
# [oak_log / 1] <- [polished_andesite_stairs / 1]
# [oak_log / 1] <- [polished_granite_stairs / 1]
# [oak_log / 1] <- [deepslate_brick_stairs / 1]
# [oak_log / 1] <- [stone_brick_stairs / 1]
# [oak_log / 1] <- [stone_stairs / 1]
# [oak_log / 1] <- [brick_stairs / 1]
# [oak_log / 1] <- [deepslate_tile_stairs / 1]

# [oak_log / 1] <- [polished_deepslate_slab / 1]
# [oak_log / 1] <- [polished_diorite_slab / 1]
# [oak_log / 1] <- [polished_andesite_slab / 1]
# [oak_log / 1] <- [polished_granite_slab / 1]
# [oak_log / 1] <- [deepslate_brick_slab / 1]
# [oak_log / 1] <- [stone_brick_slab / 1]
# [oak_log / 1] <- [stone_slab / 1]
# [oak_log / 1] <- [brick_slab / 1]
# [oak_log / 1] <- [deepslate_tile_slab / 1]

# [oak_log / 1] <- [end_stone_bricks / 1]
# [oak_log / 1] <- [prismarine_bricks / 1]
# [oak_log / 1] <- [nether_bricks / 1]
# [oak_log / 1] <- [red_nether_bricks / 1]
# [oak_log / 1] <- [mud_bricks / 1]
# [oak_log / 1] <- [purpur_block / 1]
# [oak_log / 1] <- [quartz_block / 1]
# [oak_log / 1] <- [waxed_cut_copper / 1]
# [oak_log / 1] <- [dark_prismarine / 1]

# [oak_log / 1] <- [end_stone_brick_stairs / 1]
# [oak_log / 1] <- [prismarine_brick_stairs / 1]
# [oak_log / 1] <- [nether_brick_stairs / 1]
# [oak_log / 1] <- [red_nether_brick_stairs / 1]
# [oak_log / 1] <- [mud_brick_stairs / 1]
# [oak_log / 1] <- [purpur_stairs / 1]
# [oak_log / 1] <- [quartz_stairs / 1]
# [oak_log / 1] <- [waxed_cut_copper_stairs / 1]
# [oak_log / 1] <- [dark_prismarine_stairs / 1]

# [oak_log / 1] <- [end_stone_brick_slab / 1]
# [oak_log / 1] <- [prismarine_brick_slab / 1]
# [oak_log / 1] <- [nether_brick_slab / 1]
# [oak_log / 1] <- [red_nether_brick_slab / 1]
# [oak_log / 1] <- [mud_brick_slab / 1]
# [oak_log / 1] <- [purpur_slab / 1]
# [oak_log / 1] <- [quartz_slab / 1]
# [oak_log / 1] <- [waxed_cut_copper_slab / 1]
# [oak_log / 1] <- [dark_prismarine_slab / 1]