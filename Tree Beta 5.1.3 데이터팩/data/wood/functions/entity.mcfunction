...
summon minecraft:armor_stand 29000000.5 250 28999995.5 {Tags:["normal_9"],Invisible:1b,Marker:1b}
...
summon minecraft:armor_stand 28999999.5 250 -29000006.5 {Tags:["fish_1"],Invisible:1b,Marker:1b}
summon minecraft:armor_stand 29000005.5 250 -29000006.5 {Tags:["fish_2"],Invisible:1b,Marker:1b}

# 준비중 (텍스트 디스플레이)
summon text_display 28999998.5 251.2 28999995.001 {shadow_radius:0f,billboard:"fixed",Tags:["nononononononononononono"],brightness:{sky:10,block:15},text:'[{"text":"준비중\\n","color":"dark_red","bold":true},{"text":"포탈","color":"#10B00B","bold":true}]',background:0}

# 낚시터 (텍스트 디스플레이)
summon text_display 29000002.5 251.2 28999995.001 {shadow_radius:0f,billboard:"fixed",Tags:["fishin"],brightness:{sky:10,block:15},text:'[{"text":"낚시터\\n","color":"blue","bold":true},{"text":"포탈","color":"#10B00B","bold":true}]',background:0}
summon text_display 29000004.5 251.5 -28999999.5 {shadow_radius:0f,billboard:"center",Tags:["fishout"],brightness:{sky:10,block:15},text:'[{"text":"상점\\n","color":"gold","bold":true},{"text":"포탈","color":"#10B00B","bold":true}]',background:-1778384896}
# (라마) ------------------------------
summon minecraft:llama 28999994.0 253.15 -29000019.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair1"],Rotation:[-90f,0f]}
summon minecraft:llama 28999994.0 253.15 -29000025.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair2"],Rotation:[-90f,0f]}
summon minecraft:llama 28999997.5 253.15 -29000029.0 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair3"],Rotation:[0f,0f]}
summon minecraft:llama 29000002.5 253.15 -29000029.0 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair4"],Rotation:[0f,0f]}
summon minecraft:llama 29000007.5 253.15 -29000029.0 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair5"],Rotation:[0f,0f]}
summon minecraft:llama 29000011.0 253.15 -29000025.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair6"],Rotation:[90f,0f]}
summon minecraft:llama 29000011.0 253.15 -29000019.5 {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:0}],Tags:["fish_chair7"],Rotation:[90f,0f]}

# 도박장 
# (텍스트/아이템 디스플레이)
summon text_display 29000002.5 251.2 29000005.999 {shadow_radius:0f,billboard:"fixed",Tags:["playGin"],brightness:{sky:10,block:15},text:'[{"text":"도박장\\n","color":"#ab6100","bold":true},{"text":"포탈","color":"#10B00B","bold":true}]',background:0,Rotation:[180f, 0f]}
summon text_display -29000003.5 251.5 29000000.5 {shadow_radius:0f,billboard:"center",Tags:["playGout"],brightness:{sky:10,block:15},text:'[{"text":"상점\\n","color":"gold","bold":true},{"text":"포탈","color":"#10B00B","bold":true}]',background:-1778384896}
# - 자라나라 나무!
